...
class EventInteractorProvider @Inject constructor(
    ...
    override fun get() = EventInteractor(api, defaultPageSize, markDownUrlResolver)
}
...
class IssueInteractorProvider @Inject constructor(
    ...
    private val defaultPageSize = defaultPageSizeWrapper.value
    override fun get() = IssueInteractor(api, serverChanges, defaultPageSize, markDownUrlResolver)
}
...
class MergeRequestInteractorProvider @Inject constructor(
    ...
    private val defaultPageSize = defaultPageSizeWrapper.value
    override fun get() = MergeRequestInteractor(api, serverChanges, defaultPageSize, markDownUrlResolver)
}
