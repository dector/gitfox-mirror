...
open class SDK internal constructor(
    ...
    fun getLabelInteractor() = LabelInteractor(currentSession.api, serverChanges, defaultPageSize)
    ...
    fun getMilestoneInteractor() = MilestoneInteractor(currentSession.api, serverChanges, defaultPageSize)
